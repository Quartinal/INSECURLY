...
function removeExtension(n) {
    browser.management.uninstall(n)
}
...
function toggleExtension(n, t) {
    n.hasAttribute("unchecked") ? browser.management.setEnabled(t, !0) : browser.management.setEnabled(t, !1)
}
...
async function getExtensions() {
    browser.management.getAll((async function(n) {
